...
public class ShopVo {
    ...
    public ShopVo(Integer shopId, Integer priority, Integer ownerId, Integer areaId, Integer shopCategoryId, Integer userId, Integer status, String img, String shopName, String shopDescrible, String shopPhone, String shopAdress, String advice, Date createTime, Date updateTime) {
        this.shopId = shopId;
